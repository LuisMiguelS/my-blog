                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <article class="hentry post post-standard-details">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                ...
                                <!-- Esta manera de imprimir la data permite que el gestor de plantilla traduzca etiquetas HTML siempre y cuando el contenido del post las contenga -->
                    ...
                    <div class="blog-details-author">
                        ...
                        <div class="blog-details-author-thumb">
                            <img src="{{ $post->user->profile->avatar }}" alt="Author" width="150px" height="150px" style="border-radius: 50%;">
                        </div>
